        ...
        <ul className="py-3">
          ...
          <li className="cursor-pointer" onClick={() => onSelect('TravelAndVisa')}>
            <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Travel & Visa</span>
            </div>
          </li>
          ...
          <li className="cursor-pointer" onClick={() => onSelect('References')}>
            <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">References</span>
            </div>
          </li>
          ...
          <li className="cursor-pointer" onClick={() => onSelect('WorkDetails')}>
            <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Work Details</span>
            </div>
          </li>
